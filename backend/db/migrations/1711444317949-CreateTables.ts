...
export class CreateTables1711444317949 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "admin"."question" ("id" BIGSERIAL NOT NULL, "name" TEXT NOT NULL, "description" text NOT NULL, "question_schema" text NOT NULL, "question_data" text NOT NULL, "answer_data" text NOT NULL, "max_timeout" bigint NOT NULL, CONSTRAINT "PK_21e5786aa0ea704ae185a79b2d5" PRIMARY KEY ("id"))`);
