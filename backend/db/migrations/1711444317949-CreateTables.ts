...
export class CreateTables1711444317949 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "admin"."submission" DROP CONSTRAINT "FK_8e7a0ec11b4b2f757d089fcb7c7"`);
        await queryRunner.query(`ALTER TABLE "admin"."submission" DROP CONSTRAINT "FK_af8e0428fc24c6662c6c2b28179"`);
